...
{/* <select name="cars" id="cars">
  ...
  const listOfState = states.map( function(value, index){
    return `<option value=${index}>${value.state}</option>`;
  })
  console.log(listOfState)

  const htmlConversion = listOfState.join(' ');
...
// 3. how innerHtml works in javascript
